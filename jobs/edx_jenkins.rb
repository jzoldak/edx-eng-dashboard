...
SCHEDULER.every '60s', :first_in => 0 do
    ...
    build_uri = OLD_JENKINS_JOB_URL + "/lastBuild/api/json"
    ...
    build_uri = NEW_JENKINS_JOB_URL + "/lastBuild/api/json"
